<script>
  ...
  import { sterilizer_error_code_0, sterilizer_error_code_1 } from "./error_code";
  ...
  const getST = async (url) => {
    ...
    if (url === url2.ds) {
      ...
      steamgeneratorTemperature = parseFloat(steamgeneratorTemperature).toFixed(1);
    } else if (url === url2.vet) {
      vessleExternalTemperature = data["m2m:cin"].con;
      vessleExternalTemperature = parseFloat(vessleExternalTemperature).toFixed(1);
    } else if (url === url2.vit) {
      vessleInternalTemperature = data["m2m:cin"].con;
      vessleInternalTemperature = parseFloat(vessleInternalTemperature).toFixed(1);
    } else if (url === url2.wr) {
...
<div class="col-xxl-6 col-xl-12">
  <div class="card py-3 mb-3">
    ...
    <div class="card-body py-3">
      ...
      <div class="row mt-3">
        <div class="row g-0 justify-content-between border-bottom py-2 fs--1_5 reactivePadding">
