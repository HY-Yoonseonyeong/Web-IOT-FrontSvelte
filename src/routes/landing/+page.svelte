<script>
    ...
    import DeviceStatusGrid from "../dashboard/DeviceStatusGrid.svelte";
</script>
      ...
      <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
        <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dashboards">대시보드</a>
            <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="dashboards">
              <div class="bg-white dark__bg-1000 rounded-3 py-2">
                <a class="dropdown-item link-600 fw-medium" href="/">Default</a>
                <a class="dropdown-item link-600 fw-medium" href="/">Analytics</a>
                <a class="dropdown-item link-600 fw-medium" href="/">CRM</a>
                <a class="dropdown-item link-600 fw-medium" href="/">E commerce</a>
                <a class="dropdown-item link-600 fw-medium" href="/">LMS<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a>
                <a class="dropdown-item link-600 fw-medium" href="/">Management</a>
                <a class="dropdown-item link-600 fw-medium" href="/">SaaS</a>
                <a class="dropdown-item link-600 fw-medium" href="/">Support desk<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a>
              </div>
            </div>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">회원가입</a></li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
        <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start">
          ...
          <h1 class="text-white fw-light">한영넉스
            <span class="typed-text fw-bold" data-typed-text='["AI LAB", "IOT","OCR","???"]'></span><br/>문래연구소
          </h1>
    ...
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-lg-8 col-xl-7 col-xxl-6">
          <h1 class="fs-2 fs-sm-4 fs-md-5">온습도 모니터링</h1>
