<script>
     ...
     * @returns {Promise<any>}
     */
    const queryConChange = async () => {
        const response = await fetch(`${PUBLIC_API_URL}/device/history/change`, {
            headers: {
    ...
    onMount(() => {
        queryConChange().then(data => aeiDataList = data);
      ...
      <div class="table-responsive scrollbar">
        <table class="table table-sm fs--1 mb-0 overflow-hidden">
          ...
          <tr>
            ...
            <th class="pe-1 align-middle white-space-nowrap" data-sort="device">디바이스명</th>
            <th class="pe-1 align-middle white-space-nowrap" data-sort="device">디바이스(RN)</th>
            <th class="pe-1 align-middle white-space-nowrap" data-sort="Status">CNT</th>
          ...
          {#each aeiDataList as item, index}
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle white-space-nowrap email">{item.alias}</td>
